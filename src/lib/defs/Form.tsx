  ...
  [
    ...
    <Fragment key="FormRegular">
      ...
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M25 14H20V12H25C26.6569 12 28 13.3431 28 15C28 16.6569 26.6569 18 25 18H20V16H25C25.5523 16 26 15.5523 26 15C26 14.4477 25.5523 14 25 14Z"
        fill="#4EA7AF"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M25 22H20V20H25C26.6569 20 28 21.3431 28 23C28 24.6569 26.6569 26 25 26H20V24H25C25.5523 24 26 23.5523 26 23C26 22.4477 25.5523 22 25 22Z"
        fill="#3D9298"
      />
      <path
